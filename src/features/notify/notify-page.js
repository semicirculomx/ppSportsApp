        ...
        <>
            ...
            <ListGroup variant="flush" className="">
                {notifications.length ? (
                        ...
                        switch (n.type) {
                            case 'mentioned':
                                ...
                                body = (
                                    <div className="d-flex flex-column">
                                        <p>
                                            <b>@{user.screen_name}</b> te mencionó
                                        </p>
                            ...
                            case 'followed':
                                ...
                                body = (
                                    <div className="d-flex flex-column">
                                        <p>
                                            <b>@{user.screen_name}</b> comenzó a seguirte
                                        </p>
                                    </div>
                                )
                                break
                            case 'unfollowed':
                                ...
                                body = (
                                    <div className="d-flex flex-column">
                                        <p>
                                            <b>@{user.screen_name}</b> ya no te sigue
                                        </p>
                                    </div>
                                )
                                break
                    ...
                    <div className="message font-weight-bold">No tienes notificaciones</div>
                )}
            </ListGroup>
        </>
    )
